        ...
        if (o.getClass() == Forme.class) {
            ...
            //les autres types
                ...
                do {
                    try {
                        Toolkit.getDefaultToolkit().beep();
                        nbcar = JOptionPane.showInputDialog(forme, "entrer le nombre des cases (supèrieur à 5) :",
                        ...
                        rep = JOptionPane.showConfirmDialog(forme, "Vous n'avez pas entrer une valeur entière\n"
