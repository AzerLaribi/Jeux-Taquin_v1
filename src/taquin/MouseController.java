            ...
            if (forme.isDemarrer() && !forme.isArreter()) {
                ...
                if (xMouse >= (forme.getTaille() + 4) && xMouse <= (forme.getTaille() * forme.getNbCarreaux() + forme.getTaille() + 4)) {
                    if (yMouse >= (forme.getTaille() + 50) && yMouse <= (forme.getTaille() * forme.getNbCarreaux() + forme.getTaille()) + 50) {
                        //calculer le numero de la colonne dans laquelle le carré selectionné appartient
                        xCarre = (xMouse - forme.getTaille() - 4) / forme.getTaille();
                        //calculer le numéro de la ligne dans laquelle le carré selectionné appartient
                        yCarre = (yMouse - forme.getTaille() - 50) / forme.getTaille();

                        t = carreaux[forme.getNbCarreaux() - 1][forme.getNbCarreaux() - 1].getNvEmplacement();
                        //calculer le numï¿½ro de la colonne dans laquelle le carrï¿½ blanc appartient
                        xBlanc = t % (forme.getNbCarreaux());
                        //calculer le numéro de la ligne dans laquelle le carré blanc appartient
        ...
        if (forme.isDemarrer() && !forme.isArreter()) {
            ...
            if (xMouse >= (forme.getTaille() + 4) && xMouse <= (forme.getTaille() * forme.getNbCarreaux() + forme.getTaille() + 4)) {
                if (yMouse >= (forme.getTaille() + 50) && yMouse <= (forme.getTaille() * forme.getNbCarreaux() + forme.getTaille() + 50)) {
                    ...
                    //calculer le numï¿½ro de la colonne dans laquelle le carreau selectionnï¿½ appartient
                    xCarre = (xMouse - forme.getTaille() - 4) / forme.getTaille();
                    //calculer le numï¿½ro de la ligne dans laquelle le carreau selectionnï¿½ appartient
                    yCarre = (yMouse - forme.getTaille() - 50) / forme.getTaille();

                    Carreaux[][] carreaux = forme.getCarreaux();
                    int t = carreaux[forme.getNbCarreaux() - 1][forme.getNbCarreaux() - 1].getNvEmplacement();

                    //calculer le numï¿½ro de la colonne dans laquelle le carreau blanc appartient
                    xBlanc = t % forme.getNbCarreaux();
                    //calculer le numï¿½ro de la ligne dans laquelle le carreau blanc appartient
                    yBlanc = t / forme.getNbCarreaux();
